      ...
      if (api_get_setting('search_enabled') == 'true' && extension_loaded('xapian') && !api_is_anonymous()) {
       ...
       ?>    
             <div class="head-search">
                 <?php echo api_display_tool_title(get_lang('Search'),'tablet_title'); ?>
                  <form  method="POST" onsubmit="return h_search();">
                    <span>
                    <input type="text" id="input" name="input" class="text-input-search focus" />                               
                    </span>
                    <span>

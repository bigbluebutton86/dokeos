...
$GradebookScoreDisplayColoringComment = "Vink de selectie aan om score kleuring te activeren";
...
$SeveralCoursesSubscribedToSessionBecauseOfSameVisualCode = "Verschillende trainingen zijn ingeschreven op de sessie vanwege een dubbele trainingscode.";
...
$ExportCourses = "Exporteert cursussen";
$SearchDatabaseOpeningError = "Niet gelukt om de zoek database te openen.";
...
$SearchDatabaseLockError = "Niet gelukt om de zoek database te blokkeren.";
$SearchDatabaseCreateError = "Niet gelukt om de zoek database te creëren.";
$SearchDatabaseCorruptError = "De zoekdatabank is corrupt geraakt.";
$SearchNetworkTimeoutError = "Connectie uitgevallen tijdens communicatie met de afstandszoekdatabase";
...
$LanguageIsNowHidden = "De taal is onzichtbaar gemaakt. Het zal niet mogelijk zijn om het te gebruiken totdat het zichtbaar wordt gemaakt.";
...
$ShowGlossaryInDocumentsComment = "Van hieruit kunt u configureren hoe verbindingen toegevoegd kunnen worden aan de verklarende woordenlijst van de documenten.";
$ShowGlossaryInDocumentsIsAutomatic = "Automatisch: voeg links aan elk gedefinieerde verklarende woordenlijst gevonden in dit document";
...
$TermAndConditionNotSaved = "Voorwaarden en condities niet opgeslagen";
...
$ItIsRecommendedInstallImagickExtension = "Het wordt aanbevolen om de imageick php extensie te installeren voor betere prestaties in de resolutie voor het genereren van thumbnail afbeeldingen, anders wijst het niet goed; indien niet geinstalleerd wordt standaard de php-gd extensie gebruikt.";
$EditSpecificSearchField = "Bewerk specifieke zoekvelden";
$FieldName = "Veldnaam";
$SpecialExports = "Speciale exporten";
$SpecialCreateFullBackup = "Speciale creatie volledige backup";
$SpecialLetMeSelectItems = "Speciale laat me selecteren items";
$CreateBackup = "Creëer backup";
$AllowCoachsToEditInsideTrainingSessions = "Laat trainers toe om trainingsessies te bewerken.";
$AllowCoachsToEditInsideTrainingSessionsComment = "Laat trainers toe om trainingsessie\'s commentaar te bewerken.";
...
$ToExportSpecialSelect = "Indien u trainingen wilt exporteren die sessies bevatten, dient u ervan verzekerd te zijn dat ze ook zijn opgenomen in de export. Het is daarom noodzakelijk om vanuit de lijst te selecteren.";
...
$IsNotAdministrator = "Is geen adminstrateur";
...
$MathMimetexComment = "Activeer mimeTe mathematische bewerker";
...
$BlockCopyPasteForStudentsTitle = "Blokkeer het kopieëren en plakken van studenten ";
...
$MessageMaxUploadFilesizeTitle = "Maximale oplaad bestandsgrootte in berichten";
...
$AddUsersToTrainings = "Gebruikers toevoegen aan training(en)";
$Report = "Rapport";
...
$CasUserAddLoginAttributeTitle = "XML veld voor gebruiker login";
$CasUserAddLoginAttributeComment = "Het XML veld van de CAS ticket met de gebruiker login";
$CasUserAddEmailAttributeTitle = "XML veld voor gebruikers email";
$CasUserAddEmailAttributeComment = "Het XML veld van de CAS ticket dat de gebruikersemail bevat";
...
$DetailView = "Detail weergaven van kalender gebeurtenissen";
$CalendarNavigationTitle = "Kalendar navigatie";
...
$WidgetHomepageComment = "Hoe dient de weergave van de widget paginas (modulestartpagina, campus startpagina en mijn modules paginas) eruit te zien. Deze keuze bepaalt waar u de widgets kunt plaatsen.";
...
$LoginFailLockComment = "Na hoeveel opeenvolgende foutieve wachtwoorden dient de account geblokeerd te worden. Van zodra één keer correct ingelogd wordt begint men opnieuw met 0 mislukte login pogingen";
...
$ShowEmailTemplatesTitle = "Automatische email sjablonen";
...
$Showsuccesscontent = "Toon succes mail inhoud ";
...
$InstallmentPayment = "Bericht voor 3 termijnen betaling";
...
$Register = "Registeren";
$Street = "Straat";
$Individual = "U bent een individu";

...
$langFinish = "Acabar";
$langCancel = "Cancelar";
$langNotAllowedOrSessionTimeout = "Nun tien autorización o la so sesión caducó. Por favor, entre otra vez na plataforma.";
...
$IcalExport = "Esportar en formatu ICal";
...
$SeeBlog = "Ver blogue";
$Blog = "Blogue";
$BlogPosts = "Artículos del blogue";
$BlogComments = "Comentarios de los artículos";
$GeneralHelp = "Aida Xeneral";
$ContextualHelp = "Aida Contestual";
$VisibleFor = "Visible pa";
$Templates = "Plantilles";
$FillTheBlanks = "Llena los espacios en blanco";
?>
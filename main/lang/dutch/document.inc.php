...
$langCopy = "Kopiëren";
$langTo = "naar";
$langNoSpace = "Het uploaden is niet geslaagd. Het opslagquotum is overschreden, of er is niet genoeg ruimte op de harde schijf.";
...
$langCreatePath = "Een module creëren (auteursmodule)";
...
$langWelcomeOogieSubtitle = "PowerPoint - SCORM converteerder";
...
$HelpDefaultDirDocuments = "Dit adressenbestand bevat de standaard archieven. U kunt de bestanden verwijderen of nieuwe toevoegen, maar als een bestand onzichtbaar is wanneer het wordt ingevoegd in een webdocument, zullen de studenten niet in staat zijn om dit in het document te zien. Let bij het invoegen van een bestand in een webdocument erop dat het eerst zichtbaar wordt gemaakt. De adressenbestanden kunnen onzichtbaar blijven. ";
...
$SealSize = "Maximale grootte is 130 x 130";
...
$TemplateArrowChannel = "Pijl kanaal";
...
$TemplateTitleArrowChannel = "Pijl kanaal";
$TemplateTitleArrowChannelDescription = "Pijl kanaal";
...
$Portal = "Platformnaam";
$DocumentSearch = "Zoeken naar documenten";
$DocumentSearchInformation = "Geef een term op die gezocht kan worden in de documentenruimte. Er wordt gezocht op de bestandsnaam, de commentaar en de titel van het document. In het document kan niet gezocht worden. De resultaten worden hieronder weergegeven. ";
$TooShort = "De zoekterm is te kort. De zoekterm dient minimaal drie karakters te bevatten.";
$DocumentSearchResults = "zoekresultaten voor documenten";

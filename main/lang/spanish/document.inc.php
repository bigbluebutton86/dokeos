...
$DiskQuota = "Espacio en Disco";
$MoveElement = "Mover elemento";
$DoNotEscapeSpaces = "No escapar espacios en blando de los nombre de ficheros";
...
$AddtoCourse = "Agregar Curso";
$TemplateTitleTwoColumns = "Dos Columnas";
$TemplateTitleTwoColumnsDescription = "Dos Columnas";
$TemplateArrowChannel = "Canal Flecha";
$TemplateArrowChannelDescription = "Canal paso a paso";
$TemplateTitleBiblio = "Bibliografía";
$TemplateTitleBiblioDescription = "Bibliografía";
$TemplateTitleCertificate = "Certificado";
$TemplateTitleCertificateDescription = "Certificado";
$TemplateTitleCircularFourCells = "Circular de 4 células.";
$TemplateTitleCircularFourCellsDescription = "Esquema Circular Cuatro pasos";
$TemplateTitleCircularFiveCells = "Circular de cinco células";
$TemplateTitleCircularFiveCellsDescription = "Esquema Circular Cinco Pasos";
$TemplateTitleDiagram = "Diagrama";
$TemplateTitleDiagramDescription = "Diagrama";
$TemplateArrowFaq = "Preguntas Frecuentes";
$TemplateArrowFaqDescription = "Pregunta Frecuente";
$TemplateTitleFrame = "Marco";
$TemplateTitleFrameDescription = "Marco";
$TemplateTitleGallery = "Galería";
$TemplateTitleGalleryDescription = "Galería de Imágenes";
$TemplateTitleGears = "Mecanismo";
$TemplateTitleGearsDescription = "Mecanismo";
$TemplateTitleGrowth = "Crecimiento";
$TemplateTitleGrowthDescription = "Crecimiento";
$TemplateTitleImage = "Imagen";
$TemplateTitleImageDescription = "Imagen";
$TemplateTitleItemsList = "Lista de Artículos";
$TemplateTitleItemsListDescription = "Lista de Artículos";
$TemplateTitleMap = "Mapa";
$TemplateTitleMapDescription = "Mapa";
$TemplateTitleMethodology = "Metodología";
$TemplateTitleMethodologyDescription = "Metodología";
$TemplateTitlePhases = "Fases";
$TemplateTitlePhasesDescription = "Frases";
$TemplateTitlePostIt = "Post-it";
$TemplateTitlePostItDescription = "Post-it";
$TemplateTitleProcess = "Proceso";
$TemplateTitleProcessDescription = "Proceso";
$TemplateTitlePyramid = "Pirámide";
$TemplateTitlePyramidDescription = "Pirámide";
...
$TemplateTitleSound = "Sonido";
$TemplateTitleTable = "Tabla";
$TemplateTitleTableDescription = "Tabla";
$TemplateTitleK = "Plantilla K";
$TemplateTitleKDescription = "Plantilla K";
$TemplateTitleTextArrow = "Texto con flechas";
$TemplateTitleTextArrowDescription = "Texto con flechas";
$TemplateTitleTextFourX = "Texto de cuatro pasos";
$TemplateTitleTextFourXDescription = "Texto en cuatro pasos";
$TemplateTitleTitle = "Título";
$TemplateTitleTitleDescription = "Título";
$TemplateTitleTrueFalse = "Verdadero/Falso";
$TemplateTitleTrueFalseDescription = "Verdadero / Falso";
...
$TemplateTitleArrowChannel = "Canal Flecha";
$TemplateTitleArrowChannelDescription = "Canal de Flecha";
$TemplateTitleFaq = "Preguntas Frecuentes";
$TemplateFaqDescription = "Preguntas Frecuentes";
$Tags = "Teclados";
$FillTheLibrary = "Llenar la biblioteca";
$SearchTheLibrary = "Búsqueda de la  biblioteca";
$SaveZip = "Exportar en formato zip";
$TemplatesGallery = "Galería de plantillas";
$IntegrateDocInCourse = "Integrar documentos en Curso";
$DocumentSearch = "Búsqueda de Documentos";
$DocumentSearchInformation = "Escriba una palabra para buscar en la funcionalidad de los documentos. Dokeos buscará el nombre de fichero, comentario y el título del documento. Actualmente no es posible buscar dentro del documento. Los resultados de la búsqueda se muestran a continuación";
$TooShort = "El término de búsqueda es demasiado corto. El término de búsqueda tiene que consistir de por lo menos tres caracteres.";
$DocumentSearchResults = "Resultados de la búsqueda de documentos";
$OnlyAllowedUploadAudioFilesInAudioFolder = "Solo ficheros de audio son permitidos en la carpeta Audio";
$OnlyAllowedUploadVideoFilesInVideoFolder = "Solo archivos de video son permitidos en la carpeta Video";
$OnlyAllowedUploadVideoFilesInScreencastsFolder = "Solo archivos de video son permitidos subir en la carpeta Screencasts";
$OnlyAllowedUploadMp3FilesInPodcastsFolder = "Solo archivos mp3 son permitidos en la carpeta Podcasts";
$OnlyAllowedUploadJpgGifPngFilesInPhotosFolder = "Solo archivos jpg,gif y png son permitidos en la carpeta Fotos";
$OnlyAllowedUploadJpgGifPngFilesInMascotFolder = "Solo archivos jpg,gif y png son permitidos en la carpeta Mascota";

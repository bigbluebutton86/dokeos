...
$ExercisesTracking = "Seguimiento de ejercicios";
$TrackingByQuestions = "Seguimiento por preguntas";
$TrackingByQuestionsDescription = "Con el seguimiento por pregunta, usted puede ver las respuestas más frecuentes y observar cual apartado es difícil en su ejercicio.";
$NumberOfAttempts = "Número de intentos";
$Scores = "Puntuaciones";
$AnsweredNothing = "No hay respuesta";
$GoodAnswer = "Respuesta correcta";
$WrongAnswer = "Respuesta incorrecta";
$Percent = "Porcentaje";
$IntegrateQuizInCourse = "Integrar el  examen en un módulo";
$Average = "Promedio";
$ChooseWhereTheQuizIsIntegrated = "Curso";
$QuizIntegratedInCourse = "El Examen ha sido integrado al Curso";
$QuizQuestionsPool = "Banco de preguntas";
$FeedbackIfTrue = "Feedback si es verdadero";
$FeedbackIfFalse = "Feedback si es falso";
$Reasoning = "Razonamiento";
$QuizSelfEvaluationTitle = "Autoevaluación";
$QuizExamTitle = "Examen";
$QuizExamMessage = "Evalue y califique a los aprendices igual que en un examen escrito";
$QuizSelfEvaluationMessage = "Los alumnos tienen práctica y pruebe sus habilidades";
$AddToQuiz = "Añadir al ejercicio";
$Prerequisite = "Pre-requisito";
$Beginner = "Básico";
$Intermediate = "Intermedio";
$Expert = "Experto";
$LeftSet = "Conjunto de la izquierda";
$RightSet = "Conjunto de la derecha";
$OpenAnswer = "Respuesta abierta";
$QuizMedia = "Multimedia";
$Upload = "Subir";
$UploadQuiz = "Subir ejercicio";
$Right = "Correcto";
$Wrong = "Error";
$Answer = "Respuesta";
$YourAnswers = "Tu Respuesta";
$CorrectAnswers = "Respuesta Correcta";
$PasteWord = "Pegar palabra";
$Link = "Enlace";
$Unlink = "Sin enlace";
$Images = "Imágenes";
$Imagemap = "Imagen del mapa";
$Mindmap = "Mapa Mental";
$Mascot = "Mascota";
$Flash = "Flash";
$Video = "Video";
$Flvplayer = "Video Flash (.flv)";
$Audio = "Audio";
$Glossary = "Glosario";
$Table = "Tabla";
...
$SelectReason = "Establecer Verdadero";
$FeedbackReason = "No todas son verdaderas";
$Truefalse = "Verdadero/Falso";
$Multiplechoice = "Seleccione una buena respuesta (Opción múltiple)";
$Multiplechoicesequence = "Secuencia de operaciones";
$Justifiedmultiplechoice = "Justificar su elección";
$Noneoftheabove = "Asegúrese de su respuesta (Ninguna de las anteriores es correcta)";
$Multiplechoiceimage = "Elige la imagen";
$Multiplechoicesound = "Escuchar y demostrar que entiende";
$Multiplechoicescreencast = "Captura el Screencast";
$Multiplechoiceflash = "Siga una animación Flash";
$Multiplechoicevideo = "Captar la información de un video";
$Multipleinclusion = "Incluir elementos en la lista";
$Multipleexclusion = "Elimine Intrusos desde una lista";
$Multipleanswerimage = "Analizar una imagen";
$Allitemsneeded = "Proporcionar un conjunto de respuestas (razonamiento)";
$Fillinaword = "Llenar el formulario";
$Calculatedanswer = "Calcular la respuesta";
$Itemtable = "Llenar una tabla";
$Listeningcomprehension = "Llena los espacios en blanco desde el audio.";
$Openquestion = "Respuesta libre (pregunta abierta)";
$Multiplechoicejustified = "Cuenta para una decisión";
$Commentmap = "Comentar un Mapa";
$Wordsmatching = "Unir palabras relacionadas";
$Makerightsequence = "Ordenar un Proceso (Prioridad)";
$Logicevidence = "Construir una demostración";
$Imagesmatching = "Relacionar imágenes con otras";
$Imagezone = "Identifica zonas de una imagen haciendo clic en ella";
$Sequencediagram = "Secuencia de un Diagrama";
$Sequencescreenshot = "Siga las operaciones en una captura de pantalla";
$Datatable = "Datos en una Tabla";
$Newcategory = "Categoría Nueva";
$Numberofquestion = "Número de preguntas";
$Crosswords = "Crucigrama";
$Addblank = "Agregar espacio en blanco";
$Youtube = "You Tube";
$Categories = "Categorías";
$Showemailcontent = "Mostrar contenido del correo electrónico";
$Hideemailcontent = "Ocultar el contenido del correo electrónico";
$MarksAfterCorrection = "Se evaluará la pregunta abierta después de la corrección del profesor";
?>
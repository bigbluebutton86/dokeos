...
$ShowBackLinkOnTopOfCourseTreeComment = "Tunjukkan pautan kembali ke hirarki pelatihan. Sebuah pautan terdapat dibawah senarai tersebut.";
$langUsed       = "used";
$langPresent   = "Ok";
$langMissing    = "missing";
$langExist      = "exists";
$ShowBackLinkOnTopOfCourseTree = "Tunjukkan kembali pautan dari kategori/pelatihan";
$ShowNumberOfCourses = "Tunjukkan nombor latihan";
$DisplayTeacherInCourselistTitle = "Paparkan pelatih dalam nama latihan";
$DisplayTeacherInCourselistComment = "Paparkan pelatih dalam senarai latihan";
$DisplayCourseCodeInCourselistComment = "Paparkan Kod Latihan dalam senarai latihan";
$DisplayCourseCodeInCourselistTitle = "Paparkan Kod dalam nama Latihan";

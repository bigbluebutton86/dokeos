...
$PortalLogo = "Logo del Portale";
$DiskQuota = "Spazio disco";
$SealSize = "Dimensione massima: 130 x 130";
$MoveElement = "Sposta l\'elemento";
$DoNotEscapeSpaces = "Non mettere codici di escape nei nomi dei file";
$UserFailed = "Il corsista deve ancora superare il livello di accettazione di qualche modulo: ritentare.";
$Animations = "Animazioni";
$Mindmaps = "Mappe mentali";
$Screencasts = "Condivisione schermo";
$Podcasts = "Podcast";
$Video = "Video";
$Images = "Immagini";
$Photos = "Fotografie";
...
$Filename = "Nome file";
$AddtoCourse = "Aggiungi al corso";
$TemplateTitleTwoColumns = "Due colonne";
$TemplateTitleTwoColumnsDescription = "Due colonne";
$TemplateArrowChannel = "Sequenza";
$TemplateArrowChannelDescription = "Istruzioni passo a passo";
$TemplateTitleBiblio = "Bibliografia";
$TemplateTitleBiblioDescription = "Bibliografia";
$TemplateTitleCertificate = "Certificato";
$TemplateTitleCertificateDescription = "Certificato";
$TemplateTitleCircularFourCells = "Anello con quattro caselle";
$TemplateTitleCircularFourCellsDescription = "Schema circolare con quattro caselle";
$TemplateTitleCircularFiveCells = "Anello con cinque caselle";
$TemplateTitleCircularFiveCellsDescription = "Schema circolare con cinque caselle";
$TemplateTitleDiagram = "Diagramma";
$TemplateTitleDiagramDescription = "Diagramma";
$TemplateArrowFaq = "FAQ";
$TemplateArrowFaqDescription = "Domande poste più spesso";
$TemplateTitleFrame = "Riquadro";
$TemplateTitleFrameDescription = "Riquadro evidenziato";
$TemplateTitleGallery = "Galleria";
$TemplateTitleGalleryDescription = "Galleria di immagini";
$TemplateTitleGears = "Ingranaggi";
$TemplateTitleGearsDescription = "Ingranaggi";
$TemplateTitleGrowth = "Crescita";
$TemplateTitleGrowthDescription = "Crescita";
$TemplateTitleImage = "Immagine";
$TemplateTitleImageDescription = "Immagine";
$TemplateTitleItemsList = "Elenco";
$TemplateTitleItemsListDescription = "Elenco";
$TemplateTitleMap = "Mappa";
$TemplateTitleMapDescription = "Mappa";
$TemplateTitleMethodology = "Metodo";
$TemplateTitleMethodologyDescription = "Sequenza per la realizzazione";
$TemplateTitlePhases = "Fasi";
$TemplateTitlePhasesDescription = "Elenco e descrizione delle fasi";
$TemplateTitlePostIt = "Post-it";
$TemplateTitlePostItDescription = "Post-it con annotazione";
$TemplateTitleProcess = "Processo";
$TemplateTitleProcessDescription = "Sequenza di un processo";
$TemplateTitlePyramid = "Piramide";
$TemplateTitlePyramidDescription = "Piramide";
$TemplateTitleResult = "Risultato";
$TemplateTitleResultDescription = "Precondizioni e risultato ottenuto";
$TemplateTitleSimpleBase = "Elementi base";
$TemplateTitleSimpleBaseDescription = "Descrizione degli elementi base";
$TemplateTitleSound = "Audio";
$TemplateTitleTable = "Tabella";
$TemplateTitleTableDescription = "Tabella";
$TemplateTitleK = "Espansione";
$TemplateTitleKDescription = "Espande dei termini specificandoli";
$TemplateTitleTextArrow = "Testo concatenato";
$TemplateTitleTextArrowDescription = "Caselle di testo concatenate";
$TemplateTitleTextFourX = "Matrice 2x2";
$TemplateTitleTextFourXDescription = "Quattro caselle disposte 2 x 2";
$TemplateTitleTitle = "Titolo";
$TemplateTitleTitleDescription = "Intestazione o Titolo";
$TemplateTitleTrueFalse = "Vero / Falso";
$TemplateTitleTrueFalseDescription = "Vero / Falso";
$TemplateTitleVideo320 = "Video 320";
$TemplateTitleVideo320Description = "Video piccolo";
$TemplateTitleVideo480 = "Video 480";
$TemplateTitleVideo480Description = "Video medio";
$TemplateTitleArrowChannel = "Vettore di elementi";
$TemplateTitleArrowChannelDescription = "Sequenza con conclusione";
$TemplateTitleFaq = "FAQ";
$TemplateFaqDescription = "Domande poste più spesso ";
$Tags = "Parole chiave";
$FillTheLibrary = "Riempi la libreria";
$SearchTheLibrary = "Cerca nella libreria";
$SaveZip = "Salva come zip";
$TemplatesGallery = "Galleria di Modelli";
$IntegrateDocInCourse = "Integra il documento nel modulo";
$Portal = "Titolo del portale";
$DocumentSearch = "Cerca un documento";
$DocumentSearchInformation = "Scrivi una parola per cercare un documento: la ricerca avverrà sul nome del file, sul commento e sul titolo del documento. Non è per ora possibile cercare parole all\'interno del documento.";
$TooShort = "Termine di ricerca troppo breve (sono necessari almeno tre caratteri)";
$DocumentSearchResults = "Risultato della ricerca di documenti";
$OnlyAllowedUploadAudioFilesInAudioFolder = "Nella cartella Audio possono essere caricati solo file audio";
$OnlyAllowedUploadVideoFilesInVideoFolder = "Nella cartella Video possono essere caricati solo file video";
$OnlyAllowedUploadVideoFilesInScreencastsFolder = "Nella cartella Screencast possono essere caricati solo file video";
$OnlyAllowedUploadMp3FilesInPodcastsFolder = "Nella cartella Podcast possono essere caricati solo file mp3";
$OnlyAllowedUploadJpgGifPngFilesInPhotosFolder = "Nella cartella Foto possono essere caricati solo file jpg, gif, png";
$OnlyAllowedUploadJpgGifPngFilesInMascotFolder = "Nella cartella Avatar possono essere caricati solo file jpg, gif, png";
$OnlyAllowedUploadJpgXmindGifPngFilesInMindmapsFolder = "Nella cartella Mappe mentali possono essere caricati solo file jpg, gif, png, xmind";
$OnlyAllowedUploadSwfFilesInAnimationFolder = "Nella cartella Animazioni possono essere caricati solo file swf";
$OnlyAllowedUploadJpgGifPngZipFilesInImagesFolder = "Nella cartella Immagini possono essere caricati solo file jpg, gif, pmg e zip";
$Certificate = "Certificato";
$CreateCertificate = "Crea il certificato";
$DoesNotExistsTheFolder = "La cartella non esiste";
$OrganisationLogo = "Logo dell\'istituzione";
$LogoSize = "Dimensione massima del logo: 400 x 50";
$AddLogo = "Timbro dell\'istituzione";
$PickTemplate = "Scegli il modello";
$Template1 = "Modello 1";
$Template2 = "Modello 2";
$Template3 = "Modello 3";
$Getcertificate = "Certificato sulla base di";
$GenerateCertificate = "Certifica come";
$Html = "HTML";
$Pdf = "pdf";
$Score = "Punteggio";
$Print = "Stampa";

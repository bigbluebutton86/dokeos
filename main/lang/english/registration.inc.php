...
$langTutor = "Tutor";
$langTitular = "Author";
$langAddHereSomeCourses = "<big>Edit course list</big><br><br>Check the courses you want to follow.<br>Uncheck the ones you don\'t want to follow.<br> Then click Ok at the bottom of the list";
$langStudent = "learner";
...
$langOneResp = "One of the trainers";
...
$langNowGoChooseYourCourses = "You can now go to select the course you want to access to";
...
$langRegAdmin = "Create course";
$langRegStudent = "Enroll to courses";
...
$langSubscribeUserToCourse = "Enroll users";
...
$Unreg = "Unregister";
$MyProgress = "Progress";
$ProgressIntroduction = "Select a session below.<br />Then see progress in courses";
$Select = "Validate";
...
$UsersUnsubscribed = "The users have been unsubscribed from the course";
...
$UsersRegistered = "These users have been enrolled in the course";
$UserAlreadyRegisterByOtherCreator = "User already enrolled by another tutor";
...
$UserAlreadyRegisteredByOtherCreator = "User already enrolled by another tutor";
$NewUserInTheCourse = "New user in the course";
$MessageNewUserInTheCourse = "There is a new user in the course";
$EditNormalProfile = "Minimum profile";
$EditExtendProfile = "Edit";
$EditInformation = "Edit profile";
$RegisterUser = "Validate";
$IHaveReadAndAgree = "I have read and agree to the";
$ByClickingRegisterYouAgreeTermsAndConditions = "By clicking on \'VALIDATE\' below you are agreeing to the Terms and Conditions";
$User = "User";
$LostPass = "Forgot your password ?";
$EnterEmailUserAndWellSendYouPassword = "Enter your email address. We will send you a new password";
...
$IncorrectCaptcha = "Incorrect confirmation code";
$CaptchaCheck = "Confirmation code";
$CaptchaCheckExplanation = "You have to enter the confirmation code as displayed on the image above";
$CouldNotResetPassword = "Could not reset password";
$ALinkToRecoverYourPasswordHasBeenSentToYourEmailAddress = "A link to recover your password has been sent to your e-mail address";
?>
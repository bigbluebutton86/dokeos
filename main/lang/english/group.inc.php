...
*/
$langNewGroupCreate = "New group(s)";
...
$GroupCalculator = "Group calculator";
$DeleteGroup = "Delete group(s)";
$GroupAvailablePlaces = "Seats";
$SaveGroups = "Validate";
$GroupScenarioCollaboration = "Collaboration";
$GroupScenarioCompetition = "Competition";
$SelectThisScenario = "Select this scenario";
$GroupsOf = "Groups of";
$GroupUsers = "Group users";
$GroupCategoryName = "Group category name";
$GroupScenarioCollaborationDescription = "Group scenario";
$GroupScenarioCompetition = "Competition";
$PublicPrivateGroup = "Group";
$NoGroupToolsAvailable = "No groups";
$GroupStudentRegistrationDenied = "Registration denied";
$Seats = "seats";
$GroupCategories = "Scenario";
$GroupsPerUser = "Groups by user";
...
$ScenarioText1 = "Students interact with tutor only.No interaction between students.";
$ScenarioText2 = "Students interact with tutor and each other.And they can see(but not edit) other group papers.";
$ScenarioText3 = "Students interact with tutor and each other.And they cannot see other groups papers.";
$ScenarioTools1 = "Tools : Assignments + Private email.";
$ScenarioTools2 = "Tools : Assignments + Private email + Chat + Forum + Document + Wiki";
$ScenarioTools3 = "Tools : Assignments + Private email + Chat + Forum + Document + Wiki";
$NewGroupCreated = "New Group created automatically to give space to new user";
$GroupChat = "Chat";
?>
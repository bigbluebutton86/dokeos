...
$PortalLogo = "Logotipo do Porta";
$DiskQuota = "Quota do disco";
$SealSize = "Tamanho máximo é 130 x 130";
$MoveElement = "Mover elemento";
$DoNotEscapeSpaces = "Não drexar espaços entre os nomes de arquivos";
$UserFailed = "Usuário não foi aprovado nos módulos do curso. Por favor repassar todos os módulos";
...
$DEL = "DEL";
$Template = "Modelo";
$Mediabox = "Caixa de mídias";
$Slideshow = "Slideshow";
$Filename = "Nome do arquivo";
$AddtoCourse = "Adicionar ao curso";
$TemplateTitleTwoColumns = "Duas colunas";
$TemplateTitleTwoColumnsDescription = "Duas colunas";
$TemplateArrowChannel = "Direcionar seta";
$TemplateArrowChannelDescription = "Passo a passo na direção";
$TemplateTitleBiblio = "Bibliografia";
$TemplateTitleBiblioDescription = "Bibliografia";
$TemplateTitleCertificate = "Certificado";
$TemplateTitleCertificateDescription = "Certificado";
$TemplateTitleCircularFourCells = "Circular quatro células";
$TemplateTitleCircularFourCellsDescription = "Quatro passos para circular o esquema";
$TemplateTitleCircularFiveCells = "Circular cinco células";
$TemplateTitleCircularFiveCellsDescription = "Cinco passos para circular o esquema";
$TemplateTitleDiagram = "Diagrama";
$TemplateTitleDiagramDescription = "Diagrama";
$TemplateArrowFaq = "FAQ";
$TemplateArrowFaqDescription = "Perguntas mais frequentes";
$TemplateTitleFrame = "Frame";
$TemplateTitleFrameDescription = "Frame";
$TemplateTitleGallery = "Galeria";
$TemplateTitleGalleryDescription = "Galeria de imagens";
$TemplateTitleGears = "Instalar";
$TemplateTitleGearsDescription = "Instalar";
$TemplateTitleGrowth = "Crescimento";
$TemplateTitleGrowthDescription = "Crescimento";
$TemplateTitleImage = "Imagem";
$TemplateTitleImageDescription = "Imagem";
$TemplateTitleItemsList = "Lista de Itens";
$TemplateTitleItemsListDescription = "Lista de Itens";
$TemplateTitleMap = "Mapa";
$TemplateTitleMapDescription = "Mapa";
$TemplateTitleMethodology = "Metodologia";
$TemplateTitleMethodologyDescription = "Metodologia";
$TemplateTitlePhases = "Fases";
$TemplateTitlePhasesDescription = "Fases";
$TemplateTitlePostIt = "Post-it";
$TemplateTitlePostItDescription = "Post-it";
$TemplateTitleProcess = "Processo";
$TemplateTitleProcessDescription = "Processo";
$TemplateTitlePyramid = "Pirâmide";
$TemplateTitlePyramidDescription = "Pirâmide";
$TemplateTitleResult = "Resultado";
$TemplateTitleResultDescription = "Resultado";
$TemplateTitleSimpleBase = "Base simples";
$TemplateTitleSimpleBaseDescription = "Base simples";
$TemplateTitleSound = "Som";
$TemplateTitleTable = "Tabela";
$TemplateTitleTableDescription = "Tabela";
$TemplateTitleK = "Modelo K";
$TemplateTitleKDescription = "Modelo K";
$TemplateTitleTextArrow = "Texto da seta";
$TemplateTitleTextArrowDescription = "Texto da seta";
$TemplateTitleTextFourX = "Texto quatro etapas";
$TemplateTitleTextFourXDescription = "Texto quatro etapas";
$TemplateTitleTitle = "Título";
$TemplateTitleTitleDescription = "Título";
$TemplateTitleTrueFalse = "Verdadeiro / Falso";
$TemplateTitleTrueFalseDescription = "Verdadeiro / Falso";
$TemplateTitleVideo320 = "Vídeo 320";
$TemplateTitleVideo320Description = "Vídeo 320";
$TemplateTitleVideo480 = "Vídeo 480";
$TemplateTitleVideo480Description = "Vídeo 480";
$TemplateTitleArrowChannel = "Direcionar seta";
$TemplateTitleArrowChannelDescription = "Direcionar seta";
$TemplateTitleFaq = "FAQ";
$TemplateFaqDescription = "Perguntas mais frequentes";
$Tags = "Palavras-chave";
$FillTheLibrary = "Encher a biblioteca";
$SearchTheLibrary = "Pesquisar na biblioteca";
$SaveZip = "Salvar no formato zip";
$TemplatesGallery = "Galeria de modelos";
$IntegrateDocInCourse = "Integrar Doc em um Curso";
$Portal = "Nome do Portal";
$DocumentSearch = "Pesquisa de documentos";
$DocumentSearchInformation = "Digite uma palavra para pesquisar na função documentos. O Dokeos irá procurar no comentário do arquivo, e no título do documento. Não é possível pesquisar dentro do documento. Os resultados da pesquisa são exibidos abaixo";
$TooShort = "O termo de pesquisa é muito curto. O termo de pesquisa tem de consistir em pelo menos três caracteres";
$DocumentSearchResults = "resultados da pesquisa por documentos";
$OnlyAllowedUploadAudioFilesInAudioFolder = "Apenas arquivos de áudio estão autorizados a ser carregados na pasta de áudio";
$OnlyAllowedUploadVideoFilesInVideoFolder = "Apenas arquivos de vídeo estão autorizados a ser carregados na pasta de vídeo";
$OnlyAllowedUploadVideoFilesInScreencastsFolder = "Apenas arquivos de vídeo estão autorizados a ser carregados na pasta Screencasts";
$OnlyAllowedUploadMp3FilesInPodcastsFolder = "Apenas arquivos de mp3 estão autorizados a ser carregados na pasta Podcasts";
$OnlyAllowedUploadJpgGifPngFilesInPhotosFolder = "Apenas arquivos JPG, GIF, PNG estão autorizados a ser carregados na pasta Fotos";
$OnlyAllowedUploadJpgGifPngFilesInMascotFolder = "Apenas arquivos JPG, GIF, PNG estão autorizados a ser carregar na pasta Mascote";
$OnlyAllowedUploadJpgXmindGifPngFilesInMindmapsFolder = "Apenas arquivos JPG, GIF, PNG, XMind estão autorizados a ser carregados na pasta Mindmaps";
$OnlyAllowedUploadSwfFilesInAnimationFolder = "Apenas arquivos SWF estão autorizados a ser carregados na pasta Animação";
$OnlyAllowedUploadJpgGifPngZipFilesInImagesFolder = "Apenas arquivos JPG, GIF, PNG  e zip estão autorizados a ser carregados na pasta Imagens";
$Certificate = "Certificado";
$CreateCertificate = "Criar Certificado";
$DoesNotExistsTheFolder = "A pasta não existe";
$OrganisationLogo = "Logotipo da Empresa";
$LogoSize = "Tamanho máximo é 400 x 50";
$AddLogo = "Assinatura da Empresa";
$PickTemplate = "Escolher Modelo";
$Template1 = "Modelo 1";
$Template2 = "Modelo 2";
$Template3 = "Modelo 3";
$Getcertificate = "Certificado com base";
$GenerateCertificate = "Certificado como";
$Html = "HTML";
$Pdf = "Pdf";
$Score = "Pontuação";
$Print = "Imprimir";

...
$langExist      = "existe";
$ShowBackLinkOnTopOfCourseTree = "Afficher le lien de retour en arrière dans la liste des cours";
$ShowNumberOfCourses = "Affiche le nombre de cours";
$DisplayTeacherInCourselistTitle = "Afficher le nom des formateurs";
$DisplayTeacherInCourselistComment = "Nom des formateurs dans la liste des cours";
$DisplayCourseCodeInCourselistComment = "Afficher le code du cours dans la liste.";
$DisplayCourseCodeInCourselistTitle = "Afficher le code dans l\'entête du cours";
...
$CourseCreateActiveToolsComment = "Quels outils doivent être activés (visibles) par défaut lorsqu\'un cours sera créée?";
$SearchUsers = "Chercher";
$CreateUser = "Créer utilisateur";
$ModifyInformation = "Valider";
...
$langShowUsersOfCourse = "Inscrits au cours";
$langShowClassesOfCourse = "Classes inscrites au cours";
$langShowGroupsOfCourse = "Groupes dans le cours";
$langPhone = "Téléphone";
$langPhoneNumber = "Téléphone";
$langActions = "Actions";
$langAddToCourse = "S\'inscrire à un cours";
$langDeleteFromPlatform = "Supprimer";
$langDeleteCourse = "Supprimer";
...
$langModifyCourseInfo = "Modifier les infos d\'un cours";
...
$langPleaseEnterCourseCode = "Saisissez le code du cours";
$langPleaseEnterTitularName = "Veuillez saisir le nom du formateur.";
$langPleaseEnterCourseTitle = "Saisissez le nom du cours";
...
$langOnlyUsersFromCourse = "Utilisateurs du cours";
...
$langAtLeastOneUserAndOneCourse = "Sélectionnez au moins un utilisateur et un cours";
$langClassList = "Liste des classes";
$langUserList = "Liste des utilisateurs";
$langCourseList = "Liste des cours";
$langAddToThatCourse = "Inscrire à ces cours";
...
$langFileType = "Fichier";
$langOutputFileType = "Fichier";
...
$DokeosClassic = "Dokeos classique";
...
$langAddAnnouncement = "Rédiger une nouvelle";
$langAnnouncementAdded = "La nouvelle a été ajoutée";
$langAnnouncementUpdated = "La nouvelle a été mise à jour";
$langAnnouncementDeleted = "La nouvelle a été effacée";
$langContent = "Contenu";
...
$InsertLink = "Lien";
$EditNews = "Modifier les nouvelles";
$EditCategories = "Modifier les catégories";
$EditHomePage = "Modifier";
...
$CourseAccessConfigTip = "Votre formation est publique par défaut, mais vous pouvez définir le niveau de confidentialité ci-dessus.";
$Tool = "outil";
...
$WantedCourseCode = "Code formation désiré";
...
$UseDocumentTitleComment = "Ceci permettra d\'utiliser un nom \"humain\" pour le nom du document plutôt que mon_document.doc. Pas recommandé car peut poser des problèmes d\'accès aux documents. ";
...
$ShowNavigationMenuComment = "Afficher un menu de navigation qui facilite l\'accès à différentes parties de la formation";
...
$langPpt2lp = "Oogie";
$langPpt2lpDescription = "Oogie Dokeos RAPID vous permet de transformer en quelques clics de souris une présentation PowerPoint en cours à la norme SCORM puis d\'y ajouter du son, des tests, des activités de formation et des documents multimédia ainsi que des moments d\'interaction entre les apprenants. ";
...
$keyword = "Mot-clé";
$Confirm = "Confirmer";
$UnsubscribeUsersFromCourse = "Désinscrire des utilisateurs de la formation";
$MissingClassName = "Nom de classe manquant";
$ClassNameExists = "Ce nom de classe existe déjà";
$ImportCSVFileLocation = "Fichier CSV";
...
$ExampleMaterialCourseCreationComment = "Créer une série de contenus exemples lors de la création d\'un cours";
...
$CourseListInSession = "Cours de cette session";
$UnsubscribeCoursesFromSession = "Supprimer de cette sessions les cours sélectionnés";
...
$CourseListInPlatform = "Liste de cours";
$Host = "Hôte";
...
$DateEndSession = "Date de fin de session";
...
$Ajax_course_tracking_refresh = "Calcul du temps passé dans un cours";
...
$Choose = "Choisissez";
$ModifySessionCourse = "Modifier la session";
$CourseSessionList = "Cours de la session";
...
$ListOfCoursesOfSession = "Cours de la session";
$UnsubscribeSelectedUsersFromSession = "Désinscrire les utilisateurs sélectionnés de la session";
$ShowDifferentCourseLanguageComment = "Affiche la langue de chaque cours, à côté de son nom, sur la liste des cours de la page d\'accueil";
$ShowEmptyCourseCategoriesComment = "Afficher les catégories de cours sur la page d\'accueil, même si elles sont vides";
...
$AddCSVHeader = "Ajouter en-tête CSV?";
$YesAddCSVHeader = "Oui.<br />Cette ligne définit les champs et est nécessaire lorsque vous désirez importer le fichier sur un autre portail Dokeos";
$DeleteSelectedSessions = "Supprimer les sessions sélectionnées";
$ListOfUsersSubscribedToCourse = "Liste des utilisateurs inscrits au cours";
$NumberOfCourses = "Cours";
$ShowDifferentCourseLanguage = "Afficher la langue des cours";
...
$Remove = "Éliminer";
$Rename = "Renommer";
$ShowNumberOfCoursesComment = "Affiche le nombre de cours dans chaque catégorie dans la liste des cours de la page d\'accueil";
...
$Ppt2lpVoiceRecordingNeedsRed5 = "Oogie Dokeos RAPID contribue à faire de Dokeos AUTEUR un outil en ligne de production rapide de cours. Avec la possibilité de collaborer dans la production des ressources. ";
...
$NoUserInThisSession = "Pas d\'utilisateurs dans cette session";
$SubscribeSomeUsersToThisSession = "Inscrire des utilisateurs à cette session";
$EnterStudentsToSubscribeToCourse = "Saisissez les utilisateurs que vous voulez inscrire au cours";
...
$LDAPSynchroImportUsersAndStepsInSessions = "Synchro LDAP : Import apprenants/étapes dans sessions";
...
$ImportLDAPUsersIntoSession = "Importer des utilisateurs dans une session";
...
$DefineSessionOptions = "Définir les délais d\'accès au tuteur";
...
$ExtendRightsForCoachTitle = "Donner des droits étendus au tiuteur";
...
$CannotDeleteUserBecauseOwnsCourse = "Cet utilisateur ne peut être supprimé car il est toujours formateur dans un ou plusieurs cours. Vous pouvez soit lui retirer son statut de formateur dans ces cours, soit le désactiver au lieu de le supprimer.";
$AllowUsersToCreateCoursesTitle = "Autoriser les utilisateurs non-administrateurs à créer des cours";
$AllowUsersToCreateCoursesComment = "Autoriser les formateurs à créer des cours dans le portail";
$AllowStudentsToBrowseCoursesComment = "Permettre aux apprenants de voir le catalogue de cours librement afin de s\'inscrire aux cours disponibles";
...
$ScormAndLPProgressTotalAverage = "Progrès moyen dans les modules";
...
$ScormAndLPTestTotalAverage = "Moyenne aux quiz dans les modules";
...
$CoachIsRequired = "Veuillez sélectionner un tuteur";
...
$DokeosClassic = "Dokeos Classique";
$DokeosClassic2D = "Dokeos Classique 2D";
$DokeosBlue = "Bleu Dokeos";
...
$ExportCourses = "Exporter la liste de cours";
...
$ForcePasswordChangeComment = "Après combien d\'authentifications réussies doit-on modifier le mot de passe? Si vous ne voulez pas forcer les utilisateurs à modifier leur mot de passe, tapez 0.";
...
$ListSessionCategory = "Programmes";
$AddSessionCategory = "Ajouter catégorie";
$SessionCategoryName = "Catégorie";
$EditSessionCategory = "Éditer le programme";
...
$CopyFromCourseInSessionToAnotherSession = "Copie entre sessions";
...
$ConfigureInscription = "Page d\'inscription";
...
$MathASCIImathMLTitle = "Éditeur mathématique SCIImathML (recommandé)";
...
$ReadMoreLimitTitle = "Limite ";
$ReadMoreLimitComment = "Cette limite détermine à partir de combien de mots aparaît le lien \"En savoir plus\".";
$AccessControlTitle = "Le contrôle d\'accès est activé dans Internet Explorer";
$AccessControlComment = "Le contrôle d\'accès peut poser des problèmes de navigation dans Dokeos. Si votre organisation l\'utilise, vous devriez activer cette option pour éviter les problèmes de ce type.";
$CalendarTypesTitle = "Affichage agenda";
$CalendarTypesComment = "Le calendrier affiche les événements, mais aussi les périodes d\'examen, sessions, date d\'expiration d\'un devoir à remettre...";
$AgendaDefaultViewTitle = "Vue";
$AgendaDefaultViewComment = "Trois vues : Mois, Semaine, Jour. Quelle vue souhaitez-vous? ";
$MonthView = "Mois";
$WeekView = "Semaine";
$DayView = "Jour";
$AgendaActionIconsTitle = "Icones";
$ClickToEnableOrDisable = "Cliquer pour activer ou désactiver";
$PlatformEvents = "Niveau portail";
$QuizEvents = "Quiz";
$SessionEvents = "Sessions";
$MindmapConverterTitle = "Convertisseur mindmaps";
$MindmapConverterComment = "Convertit les fichiers  XMIND et Dokeos MIND en images lorsqu\'on les importe dans l\'outil Mindmaps. Pour faire fonctionner ce convertisseur, il faut que Dokeos MIND tourne sur le serveur.";
$Trainings = "Cours";
$AddUsersToTrainings = "Valider";
$Report = "Suivi";
$AddLearners = "Ajouter des utilisateurs";
$ManageClasses = "Gérer les classes";
$CAS = "CAS";
$CasMainActivateTitle = "Activation CAS";
$CasMainActivateComment = "Voulez-vous activer l\'authentification CAS?";
$CasMainServerTitle = "Adresse du serveur CAS principal";
$CasMainServerComment = "L\'adresse IP ou le nom de votre serveur CAS";
$CasMainServerURITitle = "Racine de votre installation CAS";
$CasMainServerURIComment = "La racine de votre  CAS sans le nom de domaine";
$CasMainPortTitle = "Port CAS";
$CasMainPortComment = "Port du serveur CAS";
$CAS1Text = "CASV1";
$CAS2Text = "CASV2";
$SAMLText = "SAML";
$CasMainProtocolTitle = "Protocole CAS utilisé";
$CasMainProtocolComment = "Protocole CAS utilisé. Si vous voulez utiliser votre serveur CAS pour passer l\'information dans le ticket CAS, choisissez SAML.";
$CasUserAddActivateTitle = "Ajouter des utilisateurs par activation CAS";
$CasUserAddActivateComment = "Sélectionnez cette option si vous voulez que Dokeos ajoute l\'utilisateur avec l\'information envoyée par le serveur CAS (en utilisant SAML)";
$CasUserAddLoginAttributeTitle = "Champ XML pour le login utilisateur";
$CasUserAddEmailAttributeTitle = "Champ XML pour l\'email utilisateur";
$CasUserAddFirstnameAttributeTitle = "Champ XML pour le prénom";
$CasUserAddLastnameAttributeTitle = "Champ XML prénom";
$DisplayBreadcrumbsTitle = "Afficher les menus à la YAHOO!";
$DisplayBreadcrumbsComment = "Les fils d\'arianne doivent-ils apparaitre en haut des pages ? Cela permet une navigation plus fine pour retourner aisément d\'où vous venez.";
$DisplayPlatformHeaderInCourseComment = "Si cette option est activée, le bandeau supérieur de la plateforme affichera les onglets de navigation y compris lorsqu\'on se trouve dans un cours.";
$DisplayPlatformHeaderInCourseTitle = "Afficher l\'entête du portail dans le cours";
$DisplayContextHelpTitle = "Afficher l\'aide contextuelle";
$DisplayContextHelpComment = "Avec l\'aide contextuelle, vous pouvez obtenir de l\'aide en fonction de la page que vous visitez";
$CaptchaTitle = "Activer le Captcha";
$CaptchaComment = "Un Captcha est une vérification insérée dans un formilaire pour s\'assurer que les réponses ne sont pas générées par un ordinateur. L\'objectif est d\'éviter les problèmes de spam.";
$DisplayFeedbackMessagesTitle = "Afficher les messages de feedback";
$DisplayFeedbackMessagesComment = "Avec les messages de feedback, vous pouvez voir si certaines actions ont été effectuées avec succès ou non";
$PortalViewTitle = "Vue portail";
$PortalViewComment = "Statique ou Widgets";
$PortalViewClassic = "Statique";
$PortalViewWidget = "Widgets";
$Wysiwyg = "Editeur";
$AddToolbar = "Ajouter la barre d\'outils";
$ToolbarName = "Nom de la barre d\'outils";
$ToolbarLocation = "Place de la barre d\'outils";
$ToolbarActiveButtons = "Boutons actifs dans la barre d\'outils";
$ToolbarWidth = "Largeur";
$SavePluginSettings = "Valider";
$ToolbarHeight = "Hauteur";
$ToolbarYourConfiguration = "Votre configuration";
$ToolbarAvailableButtons = "Boutons disponibles";
$TechnicalWiki = "Wiki technique";
$WorldwideMap = "Carte du monde";
$TechnicalAssistance = "Assistance technique";
$Videoconferencing = "Vidéoconférence";
$OogieRapidLearning = "Oogie";
$CourseBuildingStudio = "Studio des concepteurs";
$ContentShop = "Magasin de contenus";
$ExportAllCoursesList = "Exporter tous les cours";
$ExportSelectedCoursesFromCoursesList = "Exporter des cours sélectionnés";
$CustomHomepageTitle = "Affichage des widgets";
$HomepageViewCustom = "Affichage widgets";
$WidgetHiddenTitleBehaviourTitle = "Comportement des titres";
$ShowToggle = "Montrer l\'interrupteur";
$ShowOnHover = "Montrer en survol";
$CustomHomepageComment = "A quoi devrait ressembler la page de widgets? Déterminez quels widgets doivent être ajoutés. ";
$ForcePasswordChangeTitle = "Forcer le changement de mot de passe";
$EmailTemplates = "Modèles de courriels";
$ToolbarTitle = "Titre de la barre des outils";
$ToolbarButtonOrder = "Ordres des boutons de la barre des outils";
$ToolbarDragDropExplanation = "Vous pouvez glisser/déposer les boutons de fonctionnalités sur les barres. ";
$EnabledLocations = "Lieux où activé";
$InstallationDateTitle = "Date d\'installation";
$InstallationDateComment = "Quand votre portail a-t-il été installé?";
$ConfigurePlugin = "Configurer le plugin";
$loginpage_main = "Page de login : section principale";
$loginpage_menu = "page de login : menu";
$campushomepage_main = "Accueil portail : zone principale";
$campushomepage_menu = "Accueil : menu";
$mycourses_main = "Mes cours : zone principale";
$mycourses_menu = "Mes cours : menu";
$header = "Entête";
$footer = "Pied de page";
$Recurrence = "Récurence";
$CalendarDetailViewTitle = "Détail événements";
$CalendarDetailViewComment = "Que doit-il se passer lorsque quelqu\'un clique sur un événement de calendrier? ";
$DetailView = "Vue detail du calendrier";
$CalendarNavigationTitle = "Navigation";
$CalendarNavigationComment = "Où afficher la barre de navigation du calendrier? ";
$CalendarNavigationActions = "Barre des tâches";
$CalendarNavigationDefault = "Dans l\'agenda";
$AllowUserEditAgendaTitle = "Agenda personnel";
$CanUsersMangeGroupAgendaTitle = "Agendas de groupe";
$CanUsersMangeGroupAgendaComment = "Permettre aux utilisateurs d\'ajouter des événements dans l\'agenda qui seront vus par les membres de leurs groupes";
$NumberOfAnnouncementsInListTitle = "Nombre d\'annonces dans la liste";
$NumberOfAnnouncementsInListComment = "Combien d\'annonces doivent apparaître dans la liste de l\'outil Annonces?";
$CalendarExportAllTitle = "Export agenda vers Outlook";
$CalendarExportAllComment = "Permettre d\'exporter tous les événements de l\'agenda en une fois?";
$GroupScenarioFieldTitle = "Champs de scénario de groupe";
$GroupScenarioFieldComment = "Quels champs doivent être disponibles pour modifier le scénario des groupes? ";
$EnrolmentToCoursesAtRegistrationToPortal = "Inscription automatique";
$ForcePasswordChangeAccountCreationTitle = "Forcer le changement de mot de passe après le premier login";
$DokeosMind = "Dokeos MIND";
$TranslationTool = "Outil de traduction";
$AuthoringStudio = "Studio auteur";
$SiteRegistered = "Portail enregistré";
$DokeosProFeatures = "Fonctionnalités PRO";
$TrainersTraining = "Formation des formateurs";
$ElearningStudio = "Studio e-learning";
$CustomDevelopment = "Développement à façon";
$HRIntegration = "Intégration RH";
$ShowQuizCategoryComment = "Faut-il organiser les quiz en catégories et interroger en fonction de ces catégories?";
$ShowQuizCategoryTitle = "Activer les catégories de quiz";
$DownloadNewVersion = "Télécharger la dernière version";
$HidePlatformHeaderInCourse = "Cacher le bandeau supérieur dans le cours";
$ShowPlatformHeaderInCourse = "Montrer le bandeau supérieur dans le cours";
$TogglePlatformHeaderInCourse = "Laisser l\'utilisateur choisir";
$GroupScenarioFieldAnnouncements = "Annonces";
$GroupScenarioFieldCalendar = "Agenda";
$GroupScenarioFieldDescription = "Projet";
$GroupScenarioFieldDocument = "Documents";
$GroupScenarioFieldForum = "Forum";
$GroupScenarioFieldLimit = "Nombre max d\'utilisateurs";
$GroupScenarioFieldPublicPrivateGroup = "Groupe privé ou public";
$GroupScenarioFieldRegistration = "Auto-inscription aux groupes";
$GroupScenarioFieldUnRegistration = "Se désinscrire d\'un groupe";
$GroupScenarioFieldWiki = "Wiki";
$GroupScenarioFieldWork = "Travaux";
$WidgetHiddenTitleBehaviourComment = "Comportement du nom du widget s\'il est masqué";
$WidgetHomepageTitle = "Affichage de la page d\'accueil des widgets";
$widgethomepage1 = "<img src=\"../img/coursehomepagelayout1.jpg\" align=\"middle\"/>";
$EditView = "Vue Edition";
$ForcePasswordChangeAccountCreationComment = "L\'utilisateur doit-il être obligé à changer de mot de passe après la première connection? ";
$PasswordRuleTitle = "Règles pour le mot de passe";
$PasswordRuleComment = "Ces règles vous permettent de forcer les utilisateurs à choisir un mot de passe plus sûr";
$PasswordRuleCamelCase = "Le mot de passe doit contenir des minuscules et des majuscules.";
$PasswordRuleNumbers = "Le mot de passe doit contenir au moins un chiffre.";
$PasswordRuleSymbol = "Le mot de passe doit contenir au moins un symbole, c\'est-à-dire un caractère non-alphanumérique comme % ! &#128;£ @";
$PasswordLengthTitle = "Longueur du mot de passe";
$PasswordLengthComment = "Combien de caractères doit contenir le mot de passe au minimum";
$LoginFailLockTitle = "Bloquer l\'utilisateur si son authentification échoue";
$LoginFailLockComment = "Nombre de logins ratés avant que Dokeos bloque l\'utilisateur";
$ShowEmailTemplatesTitle = "Activer les modèles de courriels";
$ShowEmailTemplatesComment = "Permet à l\'admin de modifier le contenu des emails envoyés automatiquement";
$dokeos2_blue = "Dokeos 2.0 blue";
$dokeos2_orange = "Dokeos 2.0 orange";
$Emailtemplates = "Modèles de courriels";
$Dontedittext = "Ne pas modifier les textes entre parenthèses {}. Par exemple {Name}";
$Automaticemails = "Courriels automatiques";
$ShowEmailTemplatesTitle = "Modèles pour les courriels automatiques";
$ShowEmailTemplatesComment = "Activer les modèles de courriels automatiques";
$PlatformAdministratorManual = "Manuel de l\'administrateur";
$TemplateDemo = "Démo";
$TemplateOverview = "Résumé";
$TemplateTeam = "Equipe";
$TemplateTestimonial = "Témoignage";
$NoTemplate = "Pas de modèle";
$EditHomeTemplates = "Editer les modèles";
$TemplateHomepage = "Accueil";
$EditHomePageDescription = "Utilisez les modèles pour modifier l\'accueil";
$TemplateMyTextHere = "Mon texte ici";
$CreatePageFromATemplate = "Nouvelle page";
$HomePage = "Accueil";
$UserListInGroup = "Utilisateurs dans le groupe";
$GroupDeleted = "Groupe effacé";
$CannotDeleteGroup = "Impossible d\'effacer le groupe";
$Quizsuccess = "Vous avez réussi le quiz";
$Showsuccesscontent = "Afficher le contenu de courrier de succès";
$Showfailurecontent = "Afficher le contenu de courrier d\'échec";
$Notes = "Notes";
$GoogleCalendarImportTitle = "Agenda Google";
$GoogleCalendarImportComment = "Activer l\'import depuis Agenda Google";
$MainSite = "Site principal";
$IsMainSite = "Portail principal";
$IsNotMainSite = "Sous-site";
$ManageMainAdministrators = "Gérer les super administrateurs";
$ManageMainAdministratorsOfTheMainSite = "Gérer les super administrateurs du site principal";
$Catalogue = "Catalogue";
$Topics = "Domaines";
$Programmes = "Programmes";
$CatalogueManagement = "Affichage du catalogue et système de paiement";
$EconomicModel = "Modèle économique";
$Commercial = "Commercial";
$NonCommercial = "Non commercial";
$Visible = "Visibilité";
$Onhomepage = "En page d\'accueil";
$Notvisible = "Non visible";
$DisplayInCatalogue = "Affichage dans le catalogue";
$ProgrammeName = "Nom du programme";
$Image = "Image";
...
$ATOSAccountNo = "Compte client ATOS";
$PaypalAccountRef = "Compte Paypal";
$FirstInstallment = "Premier paiement";
$Immediate = "Immédiat";
$SecondInstallment = "Deuxième paiement";
$Delay = "Délai";
$ThirdInstallment = "Troisième paiement";
$InstallmentSplit = "Pourcentage";
$SecondInstallmentPriceAmt = "% du prix total";
$ThirdInstallmentPriceAmt = "% du prix total";
$Weeks = "Semaines";
$MoreDetails = "Plus de détails";
$OptionSelectionText = "Texte de sélection d\'options";
$PaymentMessage = "Message pour les méthodes de paiement";
$CCPaymentMessage = "Message paiement par cartes de crédit";
$InstallmentPayment = "Message paiement en 3 fois";
$ChequePayment = "Chèque ou mandat";
$HideDetails = "Masquer les détails";
$InvoicingInformation = "Données de facturation";
$CompanyLogo = "Logo de la société";
$CompanyAddress = "Adresse de la société";
$BankDetails = "Coordonnées bancaires (RIB)";
$EmailMessage = "Envoyer un email aux administrateurs du portail quand un paiement est validé";
$NotVisible = "Non visible";
$Programme = "Programme";
$AddTopic = "Ajouter un domaine";
$TopicSettings = "Paramètres du domaine";
$TopicName = "Nom du domaine";
$CatalogueVisible = "Visible dans le catalogue";
$TopicLanguage = "Langue";
$EditCatalogue = "Editer Catalogue";
$AddProgramme = "Ajouter un programme";
$CatalogueDescription = "Fiche produit";
$Keywords = "Mots clés";
$StudentAccess = "Accés étudiant en nombre de jours";
$UnitPrice = "Prix unitaire";
$Currency = "Devise";
$Tax = "Taxe (TVA)";
$ProgrammeContentOptions = "Contenu du programme et options";
$SessionSet = "Ensemble de sessions";
$ShouldSelect = "L\'étudiant doit choisir max";
$Min = "min";
$ProgrammeSettings = "Paramètres du programme";
$SessionSettings = "Paramètres de session";
$SessionTutor = "Tuteur de session";
$Volume = "Volume";
$Schedule = "Horaire";
$Frequency = "Fréquence";
$CoursePropertiesSession = "Propriétés du cours dans la session";
$Repeats = "Répétition";
$RepeatsOn = "Tous les";
$Endson = "Se termine le";
$Ocurrences = "Récurrence";
$Weekly = "Hebdomadaire";
$EveryWeekday = "Quotidienne";
$BiWeekly = "Bi hebdomadaire";
$Monthly = "Mensuelle";
$Yearly = "Annuelle";
$CourseSet = "Ensemble de cours";
$Access = "Accès";
$LearnMore = "En savoir plus";
$AddToCart = "Continuer";
$ShowCatalogueTitle = "Afficher le titre du catalogue";
$ShowCatalogueComment = "Afficher le commentaire catalogue";
$ShowRSSInCourseTitle = "Afficher le flux RSS dans le titre du cours";
$ShowRssInCourseComment = "Autoriser le flux RSS dans chaque cours";
...
$Collectivity = "Vous agissez au nom d\'une personne morale publique ou privée";
$Personally = "vous inscrire personnellement";
$Seperate = "inscrire une tierce-personne";
$Identification = "Identification";
$YouWish = "Vous souhaitez :";
$TrainingCategory = "Catégories";
$ShowAutomaticGroupTitle = "Remplissage automatique des groupes";
$ShowAutomaticGroupComment = "Quand un utilisateur est inscrit à un cours ou à une session, l\'ajouter aussi à un groupe dans chacun des cours";
$ShowNewGroupTitle = "Créer un nouveau groupe s\'il n\'y a plus de places disponibles";
$ShowNewGroupComment = "Si l\'option \"Remplir automatiquement les groupes\" est activée mais qu\'il n\'y a plus de place dans les groupes existants, un nouveau groupe sera créé autant que de besoin pour accueillir les nouveaux inscrits. ";
$ShowNewGroupSeatTitle = "Places dans le groupe";
$ShowNewGroupSeatComment = "Nombre de places à allouer quand un groupe est créé";
$PriceNoExt = "Prix";
?>
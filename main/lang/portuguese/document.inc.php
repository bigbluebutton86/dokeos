...
$langScormcontentstudent = "Este é um módulo no formato Scorm. Para iniciar, clique aqui: <input type=button name=scormbutton value=\'Iniciar!\' onclick=\'openscorm()\'>";
...
$langCreatePath = "Criar um módulo (ferramenta de autoria)";
...
$Options = "Opções";
$WelcomeOogieConverter = "Bem-vindo ao Dokeos RAPID<ul type=\\\"1\\\"><li>Procure no disco rígido um ficheiro .ppt ou .odp<li>Envie o ficheiro para o Oogie para ser convertido num curso Scorm.<li>Poderá posteriormente adicionar comentários em formato áudio a cada slide e ainda inserir testes/exercícios e actividades entre os slides.";
...
$TemplateTitleCertificateDescription = "Para aparecer no final do módulo";
...
$AddtoCourse = "Adicionar ao módulo";
$IntegrateDocInCourse = "Adicionar documento ao módulo";
?>
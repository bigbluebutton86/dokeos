...
$max_filled_space = DocumentManager::get_course_quota();
	...
	//what's the current path?
		if(isset($_REQUEST['curdirpath']))		$path = $_REQUEST['curdirpath'];
		else									$path = '/';

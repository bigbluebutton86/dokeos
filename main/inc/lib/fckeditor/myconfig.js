...
FCKConfig.ContextMenu = ['Generic','Link','Anchor','Image','MascotManager','MindmapManager','Flash','Select','Textarea','Checkbox','Radio','TextField','HiddenField','ImageButton','Button','BulletedList','NumberedList','Table','Form'] ;

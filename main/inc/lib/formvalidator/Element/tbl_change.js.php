...
function openCalendar(form, field) {
    ...
    window.open("<?php echo api_get_path(WEB_CODE_PATH); ?>inc/lib/formvalidator/Element/calendar_popup.php", "calendar", "width=220,height=200,top=200,left=200,status=no");
	day = datevalues[0];
	month = datevalues[1];
	year = datevalues[2];
	month--;

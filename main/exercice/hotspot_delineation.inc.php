...
?>
    ...
    echo '<input type="hidden" value="'.$type_hotspost_delineation.'" name="type_hotspost"></input>';
    ...
    if ($_REQUEST['hotspotadmin'] == '' && intval($editQuestion) == 0) {
        ...
        ?>
				...
				<!--<td align="right">
					...
					<td align="center">
					<input type="text" name="weighting[1]" value="<?php echo (isset($weighting[1]) ? float_format($weighting[1], 1) : 10); ?>" size="5" />
					</td>	-->
					<td align="right">
					<?php echo get_lang('Weighting')?>
					</td>
                    ...
                    for ($i = 2; $i <= $nbrAnswers; $i++) {
                        ...
                        ?>
                            <tr  class="<?php echo $class; ?> actions">
                                ...
                                <td height="30" align="left" valign="top"><input type="text" name="reponse[<?php echo $i; ?>]" value="<?php echo api_htmlentities($reponse[$i], ENT_QUOTES, api_get_system_encoding()); ?>" size="15" />

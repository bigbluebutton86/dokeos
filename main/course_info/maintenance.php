        ...
        <table width="100%" cellspacing="2" cellpadding="10" border="0" align="center">
            <tbody>
                <tr>
                    ...
                    <td width="180px" valign="top"><?php echo Display::return_icon('instructor-table.jpg', get_lang("backup"), array('align' => 'absmiddle')); ?></td>
                </tr>
            </tbody>
        </table>
	</div>
        ...
        <table width="100%" cellspacing="2" cellpadding="10" border="0" align="center">
            <tbody>
                <tr>
                    ...
                    <td width="180px" valign="top"><?php echo Display::return_icon('Sitting05.jpg', get_lang("recycle_course"), array('align' => 'absmiddle')); ?></td>
                </tr>
            </tbody>
        </table>
    </div>
        ...
        <table width="100%" cellspacing="2" cellpadding="10" border="0" align="center">
            <tbody>
                <tr>
                    ...
                    <td width="180px" valign="top"><?php echo Display::return_icon('SpeechBoring.jpg', get_lang("DelCourse"), array('align' => 'absmiddle')); ?></td>
                </tr>
            </tbody>
        </table>
    </div>

 ...
 * Display
 */
Display::display_tool_header($nameTools,"Path");
...
if ($fileList)
{
  ...
  while (list($fileKey, $fileName) = each ($fileList['name']))
  {
    ...
    if(api_is_allowed_to_edit())
    {
     ...
     echo "<td align='center'><a href='".api_get_self()."?action=exportscorm&".api_get_cidreq()."&path=".$cmdFileName."'><img src=\"../img/save_22.png\" border=\"0\" title=\"".get_lang('Export')."\"></a>";

     /* edit title and description */

      echo "<td align='center'>",
	"<a href='".api_get_self()."?action=editscorm&path=".$cmdFileName."'><img src=\"../img/edit.png\" border=\"0\" title=\"".get_lang('_edit_learnpath')."\"></a>";
...
if (!$curDirPath) {
  ...
  while ($row=Database::fetch_array($result)) {
    ...
    if(api_is_allowed_to_edit()) {
      ...
      echo "<td align='center'><a href='".api_get_self()."?action=exportpath&id=".$row["learnpath_id"]."'><img src=\"../img/save_22.png\" border=\"0\" title=\"".get_lang('Export')."\"></a>";

      echo "<td align='center'><a href='".api_get_self()."?action=editpath&id=".$row["learnpath_id"]."'><img src=\"../img/edit.png\" border=\"0\" title=\"".get_lang('_edit_learnpath')."\"></a>";

      echo "<a href='".api_get_self()."?action=deletepath&id=".$row["learnpath_id"]."'><img src=\"../img/delete.png\" border=\"0\" title=\"".get_lang('_delete_learnpath')."\" onClick=\"return confirmation('".$row2['learnpath_name']."');\"></a>";

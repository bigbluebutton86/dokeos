...
//Dynamic file upload
$form->addElement('html', '<div id="dynamicInput"><div class="row"><div class="label">' . get_lang('File') . '</div><div class="formw"><input type="file" name="user_upload[]" id="user_upload[]" size="45"></div></div></div>');
...
// bottom actions bar
echo '<div class="actions ">';
if (isset($_GET['lp_id']) && $_GET['lp_id'] > 0) { // Actions for the Learning path
 $return = "";

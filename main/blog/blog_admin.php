...
if (api_is_allowed_to_edit())
{
	...
	*/
	...
	echo "<a href='".api_get_self()."?".api_get_cidreq()."&action=add'>",Display::return_icon('pixel.gif',get_lang('AddBlog'),array('class'=>'toolactionplaceholdericon toolactionblog_new')),get_lang('AddBlog')."</a>";
	echo '</div>';

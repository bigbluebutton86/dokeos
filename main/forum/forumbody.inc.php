...
$output .= '
			<td width="20%" class="forum-thread-header">'.get_lang('User').'&nbsp;:</td >
        	<td width="80%" class="forum-thread-body"><div align="left">'.get_name_user_by_id($userid).'</div></td>
        </tr>
        <tr>
    		<td width="20%" class="forum-thread-header">'.get_lang('Thread').'&nbsp;:</td >
            <td  width="80%" class="forum-thread-body">
                <div align="left">'.$current_thread['thread_title'].'</div>
            </td>
        </tr>

       	<tr>
    		<td width="20%" class="forum-thread-header">'.get_lang('CourseUsers').'&nbsp;:</td >
            <td  width="80%" class="forum-thread-body">
		...
		<tr>
    		<td width="20%" class="forum-thread-header">'.get_lang('PostsNumber').'&nbsp;:</td >
            <td  width="80%" class="forum-thread-body">
                <div align="left">'.$result['post'].'</div>
            </td>
        </tr>
                <tr>
    		<td width="20%" class="forum-thread-header">'.get_lang('NumberOfPostsForThisUser').'&nbsp;:</td >
            <td  width="80%" class="forum-thread-body">
                <div align="left">'.$result['user_post'].'</div>
            </td>
        </tr>
                <tr>
    		<td width="20%" class="forum-thread-header">'.get_lang('AveragePostPerUser').'&nbsp;:</td >
            <td  width="80%" class="forum-thread-body">
                <div align="left">'.round($result['user_post']/$result['post'],2).'</div>
            </td>
        </tr>
        <tr>
            <td width="20%" class="forum-thread-header"><div align="left">'.get_lang('Qualification').'&nbsp;:</div></td >
            <td  width="80%" class="forum-thread-body"><div align="left">

...
* @todo remove the code that is probably unneeded and is copied from other scripts by old developers (who allegedly produce "quality" code)
...
switch($action){
	...
	default:
		/*******************************/
		echo '<div class="note quiz_content_actions">';
		$home_notice = '';
		if(file_exists($homep.$topf.'_'.$lang.$ext)) {
